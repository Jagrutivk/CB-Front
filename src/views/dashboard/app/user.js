...
// react-boostrap
import { Container, Col, Row, Dropdown, ProgressBar, Card } from 'react-bootstrap'
...
const UserDashboard = () => {
    ...
    useEffect(() => {
        const fetchTotalMeetings = async () => {
          try {
            const response = await fetch(process.env.REACT_APP_API_URL +`/meetings/get-meeting/${userId}`);
            if (!response.ok) {
            ...
            if (data && data.results) {
              const meetingCount = data.results.length;
              console.log('Meeting count:', meetingCount);
              setTotalMeetings(meetingCount);
            } else {
              console.error('Invalid or missing meeting results in the API response.');
            }
          } catch (err) {
      ...
      useEffect(() => {
        const fetchTotalSentReferrals = async () => {
          try {
            const response = await fetch(process.env.REACT_APP_API_URL +`/referrals/get-referralByMe/${userId}`);
            if (!response.ok) {
              throw new Error(`Failed to fetch data. Status: ${response.status}`);
            }
            const data = await response.json();
            ...
            if (data && data.results) {
              ...
              console.error('Invalid or missing referral results in the API response.');
            }
          } catch (err) {
      ...
      useEffect(() => {
        const fetchTotalMyReferrals = async () => {
          try {
            const response = await fetch(process.env.REACT_APP_API_URL +`/referrals/get-referralForMe/${userId}`);
            if (!response.ok) {
              throw new Error(`Failed to fetch data. Status: ${response.status}`);
            }
            const data = await response.json();
                    ...
                    <Row as="ul" className="list-unstyled mb-0">
                            ...
                            <Card>
                                <Card.Body>
                                    <div className="points">
                                        <span>Last Month Connections</span>
                                        <div className="d-flex align-items-center">
                                            <h3>107</h3>
                                            <small className="text-success ms-3">+ 17</small>
                                        </div>
                                    </div>
                                </Card.Body>
                            </Card>
                        ...
                        <Col md="6" lg="3" as="li">
                            <Card>
                                <Card.Body>
                                    <div className="points">
                                        <span>Last Months Referrals Sent</span>
                                        <div className="d-flex align-items-center">
                                            <h3>{totalSentReferrals}</h3>
                        ...
                        <Col md="6" lg="3" as="li">
                            <Card>
                                <Card.Body>
                                    <div className="points">
                                        <span>Last Month Referrals Received</span>
                                        <div className="d-flex align-items-center">
                                            <h3>{totalMyReferrals}</h3>
                    ...
                    <Row>
                        <Col lg="8">
                            <Card className="card-block card-stretch card-height">
                                <Card.Header>
                                    <h4 className="card-title">Search Appearances</h4>
                                    <Dropdown>
                                ...
                                <Col lg="6" md="6" className="col-6">
                                    <Card>
                                        <Card.Body>
                                            ...
                                            <div className="mt-4">
                                                <h3>992</h3>
                                                <p className="mb-0">Indian Members</p>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                </Col>
                                <Col lg="6" md="6" className="col-6">
                                    <Card>
                                        <Card.Body>
                                            ...
                                            <div className="mt-4">
                                                <h3>145</h3>
                                                <p className="mb-0">Australian Members</p>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                </Col>
                                <Col lg="6" md="6" className="col-6">
                                    <Card>
                                        <Card.Body>
                                            ...
                                            <div className="mt-4">
                                                <h3>52</h3>
                                                <p className="mb-0">Japanese Members</p>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                </Col>
                                <Col lg="6" md="6" className="col-6">
                                    <Card>
                                        <Card.Body>
                                            ...
                                            <div className="mt-4">
                                                <h3>41</h3>
                                                <p className="mb-0">Brazilian Members</p>
                                            </div>
                                        </Card.Body>
                                    </Card>
                                </Col>
                        ...
                        <Col lg="8">
                            <Card className="card-block card-stretch card-height">
                                <Card.Header>
                                    <h4 className="card-title">Worldwide Members</h4>
                                    <Dropdown>
                                        <Dropdown.Toggle as={CustomToggle} variant="text-secondary">
                                            This year
                                        </Dropdown.Toggle>
                        ...
                        <Col lg="4">
                            <Card>
                                <Card.Header>
                                    <div className="header-title">
                                        <h4 className="card-title">Profile History</h4>
                                    </div>
                                </Card.Header>
                                <Card.Body className="text-center">
                                    <Chart options={adminChart2.options} className="col-md-8 col-lg-8" series={adminChart2.series} width="290" type="pie" />
                                    <p className="mb-0 mt-3">58% of Members that visit your profile sends a referral...</p>
                                </Card.Body>
                            </Card>
                        </Col>
                    </Row>
