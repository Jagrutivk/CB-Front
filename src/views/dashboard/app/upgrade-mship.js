...
const UpgradeMembership = () => {
  ...
  const handleUpgrade = () => {
    ...
    if (user_name && membership_plan) {
      alert(`Upgrade successful for ${user_name} to the ${membership_plan} membership plan. Total Price: $${planPrice}`);
    } else {
  ...
  const handleMembershipPlanChange = (selectedPlan) => {
    ...
    // Simulated price logic for upgrading - you can replace this with actual pricing logic
    ...
    <>
      <div id="content-page" className="content-page">
        <Container>
          <Row>
            <Col lg="12">
              <h2 className='pt-4 pb-4 text-center'>Upgrade Membership</h2>
              <Form>
                ...
                <Form.Group controlId="membership_plan">
                  <Form.Label>New Membership Plan</Form.Label>
                  <Form.Control
                    as="select"
                    value={membership_plan}
                    onChange={(e) => handleMembershipPlanChange(e.target.value)}
                  >
                    <option value="">Select new membership plan</option>
