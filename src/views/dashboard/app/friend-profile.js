...
const FriendProfile = () => {
  ...
  // const memberidd = location.state.memberID
   //console.log('memberId', memberidd)
   //const member_ID = sessionStorage.getItem('userID'); // Initialize member_ID
   
  // const [member_id, setMember_id] = useState(''); // Initialize member_id as a state variable
   
   useEffect(() => {
     // Check if member_id1 is available in the state, and set member_id accordingly
   //   if (state) {
   //     setMember_id(state);
   //   } else {
   //     console.log('memberId not mentioned')
   //   }
   ...
   //   const fetchMemberData = async () => {
       try {
         ...
         axios
         .get(process.env.REACT_APP_API_URL + `/members/members/${state}`, {
           headers: {
                                 ...
                                 <Card.Body>
                                    <ul className="list-inline p-0 m-0">
                                       <li className="mb-2 d-flex align-items-center">
                                          ...
                                          <p className="mb-0 ms-2">{memberData.email_id}</p>
                                       </li>
                                       <li className="mb-2 d-flex align-items-center">
                                          <span className="material-symbols-outlined md-18">
                                             gpp_good
                                          </span>
                                          <p className="mb-0 ms-2">{memberData.member_category}</p>
                                       </li>
                                       <li className="mb-2 d-flex align-items-center">
                                          <span className="material-symbols-outlined md-18">
                                             place
                                          </span>
                                          <p className="mb-0 ms-2">{memberData.country}</p>
                                       </li>
                                       <li className="d-flex align-items-center">
                                          <span className="material-symbols-outlined md-18">
                                             favorite_border
                                          </span>
                                          <p className="mb-0 ms-2">{memberData.company_name}</p>
                                       </li>
                                    </ul>
                                 </Card.Body>
                              </Card>
