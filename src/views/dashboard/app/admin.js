...
// react-boostrap
import { Container, Col, Row, Dropdown, ProgressBar, Card, Nav, Tab, OverlayTrigger, Tooltip, Modal } from 'react-bootstrap'
...
const Admin = () => {
    ...
    // //* // to get data on membership Request Tab in list //*//
    // const [membershipRequests, setMembershipRequests] = useState([]);

    // const fetchMembershipRequests = async () => {
    //     try {
    //         const response = await axios.get('process.env.REACT_APP_API_URL/membershipRequest/membership-requests');
    //         setMembershipRequests(response.data.requests); // Assuming 'requests' is the array in your response
    //     } catch (error) {
    ...
    //     try {
    //         const response = await axios.get('process.env.REACT_APP_API_URL/members/members');
    ...
    // useEffect(() => {
    //     // Fetch membership requests when the component mounts
    //     fetchMembershipRequests();
    //     // Fetch members when the component mounts
    //     fetchMembers();
    // }, []);

    // //accept reject and reviwed fuctionality 

    // const initializeButtonStatuses = (requests) => {
    //     const initialStatuses = {};
    //     requests.forEach(request => {
    //         initialStatuses[request.member_req_id] = { accept: true, reject: true, review: true };
    //     });
    //     setButtonStatuses(initialStatuses);
    // };
    // const handleAccept = (member_req_id, request) => {
    //     const requestData = { request };
    //     axios.post('process.env.REACT_APP_API_URL/members/members', request)
    //         .then(response => {
    //             console.log('Data inserted into the table:', response.data);
    //             // Remove the accepted request from the list
    //             setMembershipRequests(membershipRequests.filter(request => request.member_req_id !== member_req_id));
    //         })
    //         .catch(error => {
    ...
    // const handleReject = (member_req_id) => {
    //     const requestData = { membership_status: 'Rejected' };
    //     axios
    //         .put(`process.env.REACT_APP_API_URL/membershipRequest/membership-requests/${member_req_id}`, requestData)
    //         .then(response => {
    //             console.log('Status updated to Rejected:', response.data);
    //             const updatedButtonStatuses = { ...buttonStatuses };
    //             updatedButtonStatuses[member_req_id].reject = false;
    //             updatedButtonStatuses[member_req_id].review = true;
    //             setButtonStatuses(updatedButtonStatuses);
    //         })
    //         .catch(error => {
    ...
    // const handleReview = (member_req_id) => {
    //     const requestData = { membership_status: 'Reviewed' };
    //     axios
    //         .put(`process.env.REACT_APP_API_URL/membershipRequest/membership-requests/${member_req_id}`, requestData)
    //         .then(response => {
    //             console.log('Status updated to Reviewed:', response.data);
    //             const updatedButtonStatuses = { ...buttonStatuses };
    //             updatedButtonStatuses[member_req_id].accept = true;
    //             updatedButtonStatuses[member_req_id].reject = true;
    //             updatedButtonStatuses[member_req_id].review = false;
    //             setButtonStatuses(updatedButtonStatuses);
    //         })
    //         .catch(error => {
    ...
    // //for Home tab function
    // const [show, setShow] = useState(false);
    // const handleClose = () => setShow(false);
    // const handleShow = () => setShow(true);

    // //for member tab function
    // const questionAlert = () => {
